...
template <typename Dtype> __global__ void col2im_kernel(const int n, const Dtype* data_col,
...
template <typename Dtype> void col2im(const Dtype* data_col, const int channels,
